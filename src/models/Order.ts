...
export class Order {
  ...
  static async getAll() {
    try {
      ...
      console.log("Error: Cannot Fetch All Orders", e);
    }
  }
  ...
  static async getById(id: number) {
    ...
    try {
      ...
      console.log(`Error: Cannot Fetch Order with an id of ${id}`, e);
    }
  }
  ...
  static async getByUserId(user_id: string) {
    ...
    try {
      ...
      console.log(`Error: Cannot Fetch Orders with user_id of ${user_id}`, e);
    }
  }
  ...
  async create() {
    ...
    try {
      ...
      console.log("Error: Cannot Create New Order", e);
    }
  }
  ...
  async update() {
    ...
    try {
      ...
      console.log(`Error: Cannot Update Order with an id of ${this.id}`, e);
    }
  }
  ...
  async delete() {
    ...
    try {
      ...
      console.log(`Error: Cannot Deleting Order with an id of ${this.id}`, e);
    }
  }
}
