...
export class Product {
  ...
  static async getAll() {
    try {
      ...
      console.log("Error: Cannot Fetch All Products", e);
    }
  }
  ...
  static async getById(id: number) {
    ...
    try {
      ...
      console.log(`Error: Cannot Fetch Products with an id of ${id}`, e);
    }
  }
  ...
  async create() {
    ...
    try {
      ...
      console.log("Error: Cannot Create New Product", e);
    }
  }
  ...
  async update() {
    ...
    try {
      ...
      console.log(`Error: Cannot Update Product with an id of ${this.id}`, e);
    }
  }
  ...
  async delete() {
    ...
    try {
      ...
      console.log(`Error: Cannot Delete Product with an id of ${this.id}`, e);
    }
  }
}
