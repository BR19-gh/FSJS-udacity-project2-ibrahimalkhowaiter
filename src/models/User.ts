...
export class User {
  ...
  static async getAll() {
    try {
      ...
      console.log("Error: Cannot Fetch All Users", e);
    }
  }
  ...
  static async getById(id: string) {
    ...
    try {
      ...
      console.log(`Error: Cannot Fetch User with an id of ${id}`, e);
    }
  }
  ...
  async create() {
    ...
    try {
      ...
      console.log("Error: Cannot Create New User", e);
    }
  }
  ...
  async update(hash?: boolean) {
    ...
    try {
      ...
      console.log(`Error: Cannot Update User with an id of ${this.id}`, e);
    }
  }
  ...
  async delete() {
    ...
    try {
      ...
      console.log(`Error: Cannot Delete User with an id of ${this.id}`, e);
    }
  }
}
